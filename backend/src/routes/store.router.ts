...
import { activateStoreController, assignAdminController, createStoreController, deleteStoreController, getAdminsController, getStoreController, updateStoreController } from "../controllers/store.controller";
...
storeRouter.post("/activate-store", activateStoreController);
