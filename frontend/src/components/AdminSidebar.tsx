...
function AdminSidebar() {
  ...
  return (
    <>
      <aside className="hidden lg:block animate-in fade-in-0 slide-in-from-left-2 duration-700 lg:sticky lg:top-28 h-fit">
      ...
      <div className="fixed bottom-4 left-0 right-0 z-40 flex justify-center lg:hidden">
        <div className="flex items-center justify-between w-[90%] max-w-md bg-white border rounded-2xl shadow-lg px-6 py-3">
          {adminLinks.map((item) => {
